            ...
            <div class="container">
                ...
                <div class="row no-gutters overflow-hidden">
                    ...
                    <div class="col-lg-2 pt-0">
                        ...
                        <div class="pr-5">
                            <div class="list-group list-group-transparent mb-0">
                                ...
                                <a href="<?php echo site_url('admin/database'); ?>" class="list-group-item list-group-item-action d-flex align-items-center active">
                                ...
                                <?php endif; ?>
                                <a href="<?php echo site_url('admin/database/table'); ?>" class="list-group-item list-group-item-action d-flex align-items-center">
                    ...
                    <div class="col-lg-10 mt-70">
                                    ...
                                    if (isset($table)) {
                                        ...
                                        for ($i = 0; $i < $query->rowCount(); $i++) {
                                            ...
                                            for ($j = 0; $j < $query->columnCount(); $j++) {
                                                ...
                                                echo '<td class="d-flex flex-nowrap justify-content-center"><a href="'.site_url('admin/database/query/'.$key).'" class="text-dark table-link px-2" title="view"><i class="fa fa-binoculars text-muted" style="font-size:16px"></i></a>'.
                                                '<a href="'.site_url('admin/database/column/'.$key).'" class="text-dark table-link px-2" title="structure"><i class="fa fa-folder-open-o text-muted" style="font-size:16px"></i></a>'.
                                                '<a href="'.site_url('admin/database/insert_query/'.$key).'" class="text-dark table-link px-2" title="insert"><i class="fa fa-plus-square-o text-muted" style="font-size:18px"></i></a></td>';

                                                echo '<td><a href="'.site_url('admin/database/query/'.$key).'" class="text-dark table-link">'.$row[$col['name']].'</a></td>';
                                            }
                        ...
                        <form action="<?php echo site_url('admin/database/delete'); ?>" method="post" id="delete-form">

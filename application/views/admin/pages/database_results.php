                    ...
                    <div class="col-lg-2 pt-0">
                        ...
                        <div class="pr-5">
                            <div class="list-group list-group-transparent mb-0">
                                ...
                                <?php if ($user->user_role == "administrator"): ?>
                                    <a href="<?php echo site_url('admin/database/insert_query/'.$table); ?>" class="list-group-item list-group-item-action d-flex align-items-center">
                                        ...
                                        for ($i = 0; $i < $query->rowCount(); $i++) {
                                            ...
                                            for ($j = 0; $j < $query->columnCount(); $j++) {
                                                ...
                                                if ($col['native_type'] == "BLOB") {
                                                    echo '<td><a href="'.site_url('admin/database/edit_query/'.$table.'/'.$key.'/'.$value).'" class="text-dark table-link">'.get_summary($row[$col['name']], 2).'</a></td>';
                                                }
                                                else {
                                                    echo '<td><a href="'.site_url('admin/database/edit_query/'.$table.'/'.$key.'/'.$value).'" class="text-dark table-link">'.$row[$col['name']].'</a></td>';
                                                }
                                            }

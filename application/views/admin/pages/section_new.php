                    ...
                    <div class="col-md-3 pt-0">
                        ...
                        <div class="pr-5">
                            <div class="list-group list-group-transparent mb-0">
                                ...
                                <a href="<?php echo site_url('admin/sections/insert'); ?>" class="list-group-item list-group-item-action d-flex align-items-center active">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select" name="template" form="page-form">
                            ...
                            <form action="<?php echo site_url('admin/sections/insert'); ?>" method="post" id="page-form">
                                <div class="text-right mr-5 mt-3 pb-5">
                                    <button type="submit" class="btn btn-primary save-btn spinner">Create Section</button>&nbsp;

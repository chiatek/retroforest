	...
	<div class="page">
		...
		<div class="content">
			<div class="container">
				...
				<h1 class="h2 mb-3">A PHP Error was encountered</h1>
                <p class="h4 text-muted font-weight-normal"><strong>Severity:</strong> <?php echo $level; ?></p>
                <p class="h4 text-muted font-weight-normal"><strong>Message:</strong>  <?php echo $message; ?></p>
                <p class="h4 text-muted font-weight-normal"><strong>Filename:</strong> <?php echo $file; ?></p>
                <p class="h4 text-muted font-weight-normal"><strong>Line Number:</strong> <?php echo $line; ?></p>

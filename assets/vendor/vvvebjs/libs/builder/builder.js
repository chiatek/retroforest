...
/* controls */ 
/* *****************************  Change components to the correct path ******************************/   	
	loadControlGroups : function() {	
		...
		componentsList.each(function ()
		{
			...
			{
				list.append('<li class="editor-header clearfix" data-section="' + group + '"  data-search=""><label class="editor-header" for="' + type + '_comphead_' + group + count + '">' + group + '  <div class="editor-header-arrow"></div>\
				...
				for (i in components)
				{
					...
					if (component)
					{
						...
						if (component.image) {
							...
							item.css({
								backgroundImage: "url(http://" + window.location.hostname + '/assets/vendor/vvvebjs/libs/builder/' + component.image + ")",
	...
	loadBlockGroups : function() {	
		...
		blocksList.each(function ()
		{
			...
			{
				list.append('<li class="editor-header" data-section="' + group + '"  data-search=""><label class="editor-header" for="' + type + '_blockhead_' + group + '">' + group + '  <div class="editor-header-arrow"></div>\

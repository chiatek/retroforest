...
/* Custom CSS: background-color: tranparent; border-bottom: none; ****************/
var editor = renderer.create('<div class="note-editor note-frame card"/>');
var toolbar = renderer.create('<div class="note-toolbar-wrapper"><div class="note-toolbar card-header" style="background-color:transparent; border-bottom:none;"></div></div>');
